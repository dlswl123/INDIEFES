					    ...
					    <div id="addr_result_wrap" class="bg_white">
					    	<div class="option">
					    		<div>
					    			<b>선택장소 확인</b><br>
					    			<div id="chAddr"></div>
					    			<input type="hidden" id="place_name" name="place_name" value="${vo.place_name}"/>
					    			<input type="hidden" id="place_x" name="place_x" value="${vo.place_x}"/>
					    			<input type="hidden" id="place_y" name="place_y" value="${vo.place_y}"/>
					    		</div>
					    	</div>
					    </div>
					</div>
...
// 						}
						...
						var iwContent = '<div style="padding:5px;">' + pN + '</div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
